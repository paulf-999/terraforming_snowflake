...
# Assign Snowflake's system roles as parent roles to `OPERATIONS_ALL_ROLE`
resource "snowflake_grant_account_role" "grant_ops_all_role_to_system_roles" {
...
resource "snowflake_grant_privileges_to_account_role" "grant_warehouse_usage_to_ops_all_role" {
